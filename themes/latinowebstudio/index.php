...
echo '<div>';
  ...
  echo '<a href="' . get_the_permalink() . '" title="Read more for article ' . get_the_title() . '">';
...
echo '</a>';
  ...
  echo '<a href="' . get_the_permalink() . '" title="Read more for article ' . get_the_title() . '">Read More</a>';
  echo '</div>';
